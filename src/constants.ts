...
export const TRANSLATIONS: Record<Language, Translation> = {
  en: {
    ...
    toneClassic: "Classic Alarm (Strong)",
    timeOptionOff: "Off",
    ...
    installAndroidStep1: "Tap 'Install' button if visible, OR tap 3 dots (⋮) menu",
    installAndroidStep2: "Select 'Add to Home Screen' or 'Install App'",
    installAndroidStep3: "Tap 'Add' or 'Install' to confirm",
    ...
    installWindowsStep3: "Click 'Install' in dialog",
  ...
  ur: {
    ...
    installAndroidStep1: "'Install' بٹن دبائیں (اگر نظر آئے)، یا 3 نقطوں (⋮) کا مینو کھولیں",
    installAndroidStep2: "'Add to Home Screen' یا 'Install App' منتخب کریں",
    installAndroidStep3: "'Add' یا 'Install' بٹن دبائیں",
    ...
    installWindowsStep3: "'Install' بٹن دبائیں",
